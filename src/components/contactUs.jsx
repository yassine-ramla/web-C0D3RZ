...
export default function ContactUs() {
  return (
    <footer
      id="contact-us"
      className="w-full flex md:flex-row flex-col justify-start items-center gap-x-16 rounded-3xl px-16 py-14 from-[#251188] to-[#92e3a9] bg-gradient-to-tl"
    >
      <form action="" className="flex flex-col gap-y-10 md:w-1/2 w-full mb-16 md:mb-0">
      ...
      <div className="h-full flex flex-wrap md:flex-col justify-between gap-y-5 items-center">
